...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Infowars July 20 2018 Rodman Invites Kanye to North Korea";
        CTransaction txNew;
        txNew.nTime = 1532147267;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1532147267;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1982026 : 1982026;
        ...
        assert(block.hashMerkleRoot == uint256("0x1a47f3ad01d940bdb527cbaef4e5158e60b80b08c68d6a51fc9528e05f77546d"));
...
unsigned char pchMessageStart[4] = { 0x24, 0xa6, 0x54, 0x70 };
